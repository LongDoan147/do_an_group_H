        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-md-12 col-sm-12">
                <div class="woo_pr_detail">
                    ...
                    <div class="woo_btn_action">
                        <div class="col-12 col-lg-auto">
                            <button type="submit" id="addCart" data-id="{{$product->id}}" class="btn btn-block btn-dark mb-2">Thêm Vào Giỏ <i class="fa fa-plus-circle ml-2" aria-hidden="true"></i></button>
                        </div>
                        <div class="col-12 col-lg-auto">
                            <a href="" class="btn btn-theme btn-wishlist btn-block mb-2">Yêu Thích <i class="fas fa-heart ml-2"></i></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="custom-tab style-1">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="description-tab" data-toggle="tab" href="#description" role="tab" aria-controls="description" aria-selected="true" aria-expanded="true">Thông
                                        tin</a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="reviews-faceboook-tab" data-toggle="tab" href="#reviews-faceboook" role="tab" aria-controls="reviews-faceboook" aria-selected="false" aria-expanded="false">Bình luận</a>
                                </li>
                            </ul>
                            <div class="tab-content" id="myTabContent">
                                                        ...
                                                        <div class="review-body">
                                                            ...
                                                            <div class="review-content">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    <a href="" data-id="{{$value->id}}" class="reply_commment">Trả
                                                                        lời</a>
                                                                    @if($value->id_khachhang === get_user('customer',
                                                                    'id'))
                                                                    <a href="" class="reply_commment delete">Xoá</a>
                                                                    @endif
                                                                                ...
                                                                                <div class="review-body">
                                                                                    ...
                                                                                    <div class="review-content">
                                                                                        ...
                                                                                        <div class="col-sm-12">
                                                                                            ...
                                                                                            <a href="{{ route('delete.comment', $reply->id)}}" class="reply_commment delete">Xoá</a>
                                                                                            @endif
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                    ...
                                    <div class="review-wrapper">
                                        ...
                                        <div class="review-wrapper-body">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    <a href="" class="btn btn-primary sendComments">Gửi</a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade " id="reviews-faceboook" role="tabpanel" aria-labelledby="reviews-faceboook" aria-expanded="true">
                                    <p>
