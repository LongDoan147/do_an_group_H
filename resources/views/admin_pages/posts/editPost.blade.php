...
<div class="container-fluid coupon form_ql">
    <div class="card_1">
        ...
        <div class="form-submit">
            <form action="{{ route('save.edit.post',$post->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-8 col-12">
                        <div class="form_group">
                            <label>Tiêu đề</label>
                            <input name="tieude" autocomplete='off' value=" {{$post->tieude}}" class="form_control" />
                        </div>
                        ...
                        <div class="form_group">
                            ...
                            <select name="danhmuc" class="form_control">
                                ...
                                <option value="{{$value->id}}" {{ $post->id_danhmuc === $value->id ? 'selected' : ''}}>
                        ...
                        <div class=" img-preview">
                            <label for="img" class="preview">
                                ...
                                <span>Chọn ảnh cần thêm</soan>
                                    @if($post->hinhanh)
                                    <image src="{{ asset('uploads/post/' . $post->hinhanh) }}">
                                        @endif
                            </label>
                    ...
                    <div class="col-12">
                        <div class="form_group">
                            <label>Mô tả</label>
                            <textarea class="form_control" name="noidung" id="contentEmail">
                            {{$post->noidung}}
                            </textarea>
                        </div>
